...
class FlaggerApplication : Application() {
    private val activityLifecycleCallbacks = FlaggerCallbacks()
...
//    private fun showOnboarding(): Boolean = !SharedPrefs.onBoardingCompleted or SharedPrefs.showOnboarding
    ...
    companion object {
        private lateinit var instance: FlaggerApplication
...
//                Timber.e("Failed accessing current activity $e")
        ...
        fun getCurrentApp(): FlaggerApplication? {
            return instance
        }
